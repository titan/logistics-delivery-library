defmodule Delivery.Api do
  ...
  """
  @spec search_by_consigner_license(String.t) :: {:ok, [Delivery.Entity.t]} | {:error, code, reason}
  ...
  @spec remote_call(atom, [integer | String.t]) :: :ok | {:ok, Delivery.Entity.t} | {:ok, [Delivery.Entity.t]} | {:ok, [Delivery.Event.t]} | {:error, code, reason}
